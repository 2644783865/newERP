<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientList.aspx.cs" Inherits="Infobasis.Web.Pages.Design.ClientList"
        ...
        <Items>
                                ...
                                <Items>
                                    <f:Panel ID="Panel2" runat="server" Layout="HBox" ShowBorder="false" ShowHeader="false">
                                        <Items>
                                            ...
                                            <f:LinkButton ID="LinkButton1"  runat="server" CssStyle="margin-left:6px;" Text="重置">
                                                <Listeners>
                                            ...
                                            <f:Button ID="btnAssignSelected" Icon="ArrowSwitch" runat="server" Text="分配设计师">
                                            </f:Button>
            ...
            <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                ...
                <Columns>
                    ...
                    <f:BoundField DataField="BuiltupArea" SortField="BuiltupArea" Width="40px"  HeaderText="㎡" />
                    <f:BoundField DataField="Budget" SortField="Budget" Width="40px"  HeaderText="预" />
                    ...
                    <f:BoundField ID="BoundField1" ColumnID="bfTraceNum" runat="server" Width="70px" TextAlign="Center"></f:BoundField>
                    <f:WindowField ColumnID="changeToNextField" TextAlign="Center" Icon="ArrowBranch" ToolTip="选部门" HeaderText=""
                        WindowID="Window1" Title="选部门" Text="选部门" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/Pages/Admin/User_Changepassword.aspx?id={0}"
                        Width="70px" />
                    <f:TemplateField HeaderText="" TextAlign="Center" Width="100px">
                        <ItemTemplate>
                            <a href="javascript:;" onclick="<%# GetDesignProgressEditUrl(Eval("Id"), Eval("Name")) %>"><span><i class="ui-icon f-grid-cell-iconfont f-icon-th-list"></i> <%# GetDesignProgressLinkName(Eval("Id"), Eval("Name")) %></span></a>
                        </ItemTemplate>
                    </f:TemplateField>
                    <f:WindowField ColumnID="designBudget" TextAlign="Center" IconFont="Cny" ToolTip="创建预算" HeaderText="预算"
                        WindowID="Window1" Title="创建预算" Text="创建预算" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/Pages/Business/DisableClient.aspx?id={0}"
                        Width="90px" />
...
<asp:Content ID="ScriptContent" runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        ...
        function getEditWindowUrl(id, name) {
            return F.baseUrl + 'Pages/Design/DesignProgress.aspx?id=' + id + '&name=' + name + '&parenttabid=' + parent.getActiveTabId();
        }
