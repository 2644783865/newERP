<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Job.aspx.cs" Inherits="Infobasis.Web.Pages.HR.Job" 
    ...
    <f:Panel ID="Panel1" runat="server" BodyPadding="5px" 
        ...
        <Items>
            ...
            <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                ...
                OnPageIndexChange="Grid1_PageIndexChange" MouseWheelSelection="true" QuickPaging="true" EnableTextSelection="true">
                <Toolbars>
                ...
                <Columns>
                    ...
                    <f:BoundField DataField="Level" SortField="Level" Width="60px" HeaderText="级别" />
                    <f:CheckBoxField DataField="IsActive" HeaderText="启用" RenderAsStaticField="true"
                        AutoPostBack="true" CommandName="IsActive" Width="100px" />
                    ...
                    <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑" WindowID="Window1"
                        Title="编辑" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/Pages/HR/Job_Form.aspx?id={0}"
                        Width="50px" />
