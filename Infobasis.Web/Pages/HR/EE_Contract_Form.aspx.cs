...
{
    public partial class EE_Contract_Form : PageBase
    {
        ...
        private void LoadData()
        {
            ...
            if (id > 0)
            {
                EmployeeContract current = DB.EmployeeContracts.Find(id);
                if (current == null)
                {
                ...
                tbxContractNo.Text = current.ContractCode;
                tbxJobTitle.Text = current.JobTitle;
                tbxStartDate.Text = current.ContractStartDate.ToString();
                tbxEndDate.Text = current.ContractEndDate.ToString();
