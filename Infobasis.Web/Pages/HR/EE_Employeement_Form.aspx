<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EE_Employeement_Form.aspx.cs" Inherits="Infobasis.Web.Pages.HR.EE_Employeement_Form"
            ...
            <Items>
                <f:Panel ID="Panel3" ShowHeader="false" CssClass="" ShowBorder="false" Layout="Column" runat="server">
                    <Items>
                        ...
                        <f:TextBox ID="tbxCompanyName" ShowLabel="false" Label="工作单位" Required="true" Width="200px" CssClass="marginr" runat="server">
                        </f:TextBox>
                ...
                <f:Panel ID="Panel13" ShowHeader="false" ShowBorder="false" Layout="Column" CssClass="" runat="server">
                    <Items>
                        <f:TextArea ID="tbxLeaveReason" runat="server" Label="离职原因">
                        </f:TextArea>
                    </Items>
                </f:Panel>
