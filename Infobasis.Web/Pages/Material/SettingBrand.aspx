<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SettingBrand.aspx.cs" Inherits="Infobasis.Web.Pages.Material.SettingBrand" 
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <f:Panel ID="Panel1" runat="server" BodyPadding="5px" 
        ...
        BoxConfigPosition="Start" ShowHeader="false" Title="品牌管理">
        <Items>
            ...
            <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                ...
                OnSort="Grid1_Sort"  SortField="DisplayOrder" SortDirection="ASC" AllowPaging="true"
                ...
                <Columns>
                    ...
                    <f:CheckBoxField DataField="IsActive" HeaderText="启用" RenderAsStaticField="true" Width="100px" />
                    <f:BoundField DataField="Remark" ExpandUnusedSpace="true" HeaderText="备注" />
                    <f:BoundField DataField="DisplayOrder" ExpandUnusedSpace="false" HeaderText="排序" />
                    <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑"
                        WindowID="Window1" Title="编辑" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/Pages/Admin/Role_Form.aspx?id={0}"
                        Width="50px" />
