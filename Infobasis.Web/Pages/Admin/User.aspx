<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="Infobasis.Web.Pages.Admin.User" 
...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
            ...
            <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                ...
                <Columns>
                    ...
                    <f:WindowField ColumnID="changePasswordField" TextAlign="Center" Icon="Key" ToolTip="修改密码"
                        WindowID="Window1" Title="修改密码" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/Pages/Admin/User_Changepassword.aspx?id={0}"
                        Width="50px" />
                    <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑"
                        WindowID="Window1" Title="编辑" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/Pages/Admin/User_Form.aspx?id={0}"
                        Width="50px" />
    ...
    <f:Menu ID="Menu1" runat="server">
        <f:MenuButton ID="mbEnableRows" OnClick="btnEnableUsers_Click" runat="server" Text="启用用户">
        </f:MenuButton>
        <f:MenuButton ID="mbDisableRows" OnClick="btnDisableUsers_Click" runat="server" Text="禁用用户">
        </f:MenuButton>
        <%--<f:MenuSeparator runat="server"></f:MenuSeparator>
        <f:MenuButton ID="mbDeleteRows" OnClick="btnDeleteSelected_Click" runat="server" Text="删除行">
        </f:MenuButton>--%>
    </f:Menu>
