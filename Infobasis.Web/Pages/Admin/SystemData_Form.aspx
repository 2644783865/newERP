<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SystemData_Form.aspx.cs" Inherits="Infobasis.Web.Pages.Admin.SystemData_Form"
    ...
    <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
                ...
                <Items>
                    <f:TextBox ID="tbxCode" runat="server" Label="编号" Required="true" ShowRedStar="true"></f:TextBox>
