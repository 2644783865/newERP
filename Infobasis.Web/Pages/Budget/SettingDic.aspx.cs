...
{
    public partial class SettingDic : PageBase
    {

        public int Grid1SelectedRowIndex
        {
            get { return Grid1.SelectedRowIndex; }
        }
        ...
        private void LoadData()
        {
            ...
            ScrollToSelectedRow(Grid1);
            BindGrid2();
        }

        private void BindGrid1()
        {
            IQueryable<EntityList> q = DB.EntityLists.Where(item => item.GroupCode == "Budget").OrderBy(item => item.DisplayOrder);
        ...
        protected void btnNew_Click(object sender, EventArgs e)
        {
            ...
            string addUrl = String.Format("~/Pages/Admin/SystemData_Form.aspx?pid={0}&scrollid={1}", id, Grid1.SelectedRowIndex);

            PageContext.RegisterStartupScript(Window1.GetShowReference(addUrl, "添加数据"));
        }
