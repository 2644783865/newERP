<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SettingDic.aspx.cs" Inherits="Infobasis.Web.Pages.Budget.SettingDic" 
                    ...
                    <f:Grid ID="Grid2" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false" EnableCheckBoxSelect="true" 
                        ...
                        <Columns>
                            ...
                            <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑"
                                WindowID="Window1" Title="编辑" DataIFrameUrlFields="ID,EntityListID,Grid1SelectedRowIndex" DataIFrameUrlFormatString="~/Pages/Admin/SystemData_Form.aspx?id={0}&pid={1}&scrollid={2}"
                                Width="50px" />
