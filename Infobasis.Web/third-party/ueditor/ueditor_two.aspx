        ...
        <f:SimpleForm ID="Form1" BodyPadding="5px" LabelWidth="80px" Width="900px" EnableCollapse="true"
            ...
            <Items>
                ...
                <f:HtmlEditor runat="server" Label="文章正文" ID="HtmlEditor1"
                    Editor="UEditor" BasePath="~/third-party/res/ueditor/" ToolbarSet="Full" Height="400px">
                </f:HtmlEditor>
                <f:HtmlEditor runat="server" Label="文章摘要" ID="HtmlEditor2"
                    Editor="UEditor" BasePath="~/third-party/res/ueditor/" ToolbarSet="Basic" Height="200px">
                </f:HtmlEditor>
            </Items>
            <Toolbars>
