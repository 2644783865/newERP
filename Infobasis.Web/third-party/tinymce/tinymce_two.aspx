<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tinymce_two.aspx.cs" ValidateRequest="false"
    Inherits="FineUIPro.Examples.aspnet.tinymce_two" %>
        ...
        <f:SimpleForm ID="Form1" BodyPadding="5px" LabelWidth="80px" Width="900px" EnableCollapse="true"
            ...
            <Items>
                ...
                <f:HtmlEditor runat="server" Label="文章正文" ID="HtmlEditor1"
                    Editor="TinyMCE" BasePath="~/third-party/res/tinymce/" ToolbarSet="Full" Height="400px">
                </f:HtmlEditor>
                <f:HtmlEditor runat="server" Label="文章摘要" ID="HtmlEditor2"
                    Editor="TinyMCE" BasePath="~/third-party/res/tinymce/" ToolbarSet="Basic" Height="200px">
                </f:HtmlEditor>
            </Items>
            <Toolbars>
