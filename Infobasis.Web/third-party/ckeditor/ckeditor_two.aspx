<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ckeditor_two.aspx.cs" ValidateRequest="false"
    Inherits="FineUIPro.Examples.aspnet.ckeditor_two" %>
        ...
        <f:SimpleForm ID="Form1" BodyPadding="5px" LabelWidth="80px" Width="900px" EnableCollapse="true"
            ...
            <Items>
                ...
                <f:HtmlEditor runat="server" Label="文章正文" ID="HtmlEditor1"
                    Editor="CKEditor" BasePath="~/third-party/res/ckeditor/" ToolbarSet="Full" Height="400px">
                </f:HtmlEditor>
                <f:HtmlEditor runat="server" Label="文章摘要" ID="HtmlEditor2"
                    Editor="CKEditor" BasePath="~/third-party/res/ckeditor/" ToolbarSet="Basic" Height="200px">
                </f:HtmlEditor>
            </Items>
            <Toolbars>
