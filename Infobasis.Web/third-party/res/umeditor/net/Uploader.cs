...
namespace FineUIPro.Examples.res.umeditor.net
{
    ...
    public class Uploader
    {
      ...
      */
        ...
        {
            pathbase = pathbase + "\\images\\umeditor\\" + UserInfo.Current.CompanyID.ToString() + "\\" + DateTime.Now.ToString("yyyyMM") + "\\";
            uploadpath = pathbase;
            ...
            try
            {
                ...
                if (state == "SUCCESS")
                {
                    ...
                    URL = "../../../../" + Global.UploadFolderVirualPath + "/images/umeditor/" + UserInfo.Current.CompanyID.ToString() + "/" + DateTime.Now.ToString("yyyyMM") + "/" + filename;
                }
            }
            catch (Exception)
            {
