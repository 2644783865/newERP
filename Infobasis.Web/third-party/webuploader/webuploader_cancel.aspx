...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" runat="server" ShowHeader="true" ShowBorder="true" Title="文件上传（上传过程中可以取消上传）"
            ...
            <Columns>
                ...
                <f:LinkButtonField ColumnID='FileDelete' Width="80px" ConfirmText="你确定要删除这个文件吗？" ConfirmTarget="Top"
    ...
    <script type="text/javascript">
        ...
        F.ready(function () {
            ...
            uploader.on('uploadComplete', function (file) {
                ...
                // 上传结束，删除 [取消上传] 按钮
                var cellEl = grid.getCellEl(file.id, 'FileDelete').find('.f-grid-cell-inner');
                cellEl.text('');
            });
            ...
            // 表格中的 取消上传 按钮
            grid.el.on('click', 'a.thecanceluploadbutton', function (event) {
                var targetEl = $(this);
