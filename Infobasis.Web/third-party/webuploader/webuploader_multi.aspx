...
<body>
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" BodyPadding="5px" LabelWidth="80px" Width="800px" EnableCollapse="true"
                ...
                <f:FormRow>
                    <Items>
                        <f:Grid ID="Grid1" runat="server" ShowHeader="true" ShowBorder="true" Title=""
                            ...
                            <Tools>
                                <f:Tool runat="server" ID="btnSelectFiles" EnablePostBack="false" IconFont="Plus" Text="上传Excel"></f:Tool>
                            </Tools>
                            <Columns>
                                <f:BoundField ColumnID="FileName" DataField="name" DataToolTipField="name" HeaderText="文件名" ExpandUnusedSpace="True" />
                        ...
                        <f:Grid ID="Grid2" runat="server" ShowHeader="true" ShowBorder="true" Title=""
                            ...
                            <Tools>
                                <f:Tool runat="server" ID="btnSelectFiles2" EnablePostBack="false" IconFont="Plus" Text="上传图片"></f:Tool>
                            </Tools>
                            <Columns>
                                <f:BoundField ColumnID="FileName" DataField="name" DataToolTipField="name" HeaderText="文件名" ExpandUnusedSpace="True" />
                                <f:RenderField ColumnID="FileSize" DataField="size" HeaderText="大小" Renderer="FileSize" Width="100px" />
